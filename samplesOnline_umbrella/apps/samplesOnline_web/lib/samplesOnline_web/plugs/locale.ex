defmodule SamplesOnlineWeb.Plugs.Locale do
    import Plug.Conn # Let this module know it is a plug
  
    @locales Gettext.known_locales(SamplesOnlineWeb.Gettext) #One time retrieve the locales from the config file and store it in a @locales variable.
    ...
    def call(conn, _options) do
      case fetch_locale_from(conn) do
        ...
        SamplesOnlineWeb.Gettext |> Gettext.put_locale(locale)
